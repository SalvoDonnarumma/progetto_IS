...
<body>
    <div class="error-message">
        <h2>Errore di durante la Validazione Dei Dati Utente</h2>
        <p>Uno dei campi per la validazione dei dati utente è scritto male. Per favore, verifica i dati inseriti.</p>
